...
export const tagTypeMapping: Record<TagType, [string, string[]]> = {
 ...
 "character-quality": ['yellow', ["subsurface skin scattering","shiny skin","beautiful detailed eyes","realistic", "photorealistic", "well-lit face","smooth","glowing face","highly detailed facial features",]],
